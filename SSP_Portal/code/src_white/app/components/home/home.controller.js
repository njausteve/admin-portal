...
(function() {
    ...
    /** @ngInject */
    function HomeController(deviceDetector, homeService, $log, toastrConfig, toastr, constants, $rootScope) {
        ...
        function _detectDevice() {
            ...
            _getSupportedOsVersions().then(function(response) {
                ...
                if (vm.supportedOsVersions) {
                    ...
                    for (var i = 0; i < vm.supportedOsVersions.length; i++) {
                        if (vm.supportedOsVersions[i].platform == 'Android') {
                            vm.supportedOsVersions.android = vm.supportedOsVersions[i];
                        } else if (vm.supportedOsVersions[i].platform == 'Ios') {
                            vm.supportedOsVersions.ios = vm.supportedOsVersions[i];
                        }
                    }
                    ...
                    if (vm.os == "ios") {
                        ...
                        if (parseInt(vm.deviceVersion) >= parseInt(vm.supportedOsVersions.ios.minVersion) && parseInt(vm.deviceVersion) <= parseInt(vm.supportedOsVersions.ios.maxVersion)) {
                            vm.validOS = true;
                        }
                        ...
                        if (parseInt(vm.deviceVersion) >= parseInt(vm.supportedOsVersions.android.minVersion) && parseInt(vm.deviceVersion) <= parseInt(vm.supportedOsVersions.android.maxVersion)) {
                            vm.validOS = true;
                        }
                    }
                } else {
